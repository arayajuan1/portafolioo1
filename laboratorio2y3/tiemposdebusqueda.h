...
////////////////////////////
void crear_archivo_tiempo_secuencial(int dato)
{
	FILE *op;
	 op=fopen("tiempo_de_busqueda_secuencial111.txt","a");
	if(op==NULL)
	{
...
////////////////////////////
void crear_archivo_tiempo_binario(int dato)
{
	FILE *op;
	 op=fopen("tiempo_de_busqueda_binario111.txt","a");
	if(op==NULL)
	{
		printf("error al crear archivo\n");
	}
...
void busqueda_secuencial(int tamano_inicial_lista, int tiemp_de_busqueda)
{
	int i=0;
	while(i<1000)
	{
		...
		printf("tamaño inicial lista \n :%d \n",tamano_inicial_lista);
		 ...
		 crear_archivo_tiempo_secuencial(tiemp_de_busqueda);
	//	 printf("i:%d \n",i);
		i++;
...
//////////////////////////////////////7
void busqueda_binaria(int tamano_inicial_lista,int tiemp_de_busqueda)
{
	int i=0;
	while(i<1000)
	{
	 ...
	 //   qsort(lista_de_numeros->array,tamano_inicial_lista,sizeof(int),&comparar_enteros);
		...
		printf("tamaño inicial lista \n :%d \n",tamano_inicial_lista);
		 ...
		 crear_archivo_tiempo_binario(tiemp_de_busqueda);
//		 printf("i:%d \n",i);
		i++;
